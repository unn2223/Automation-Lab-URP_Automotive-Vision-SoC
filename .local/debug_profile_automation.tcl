...
namespace eval dpa {
  ...
  #      * Default clock is idenfied with id=0 in PFM.CLOCK property
  ...
  proc get_aie_trace_clock {clockSelect} {
    ...
    # We must have the PFM.CLOCK clock wizard
    if {$pfmClock == {}} {
      send_msg_id "101-1" "ERROR" "Unable to find clock wizard with PFM.CLOCK defined\
          for AIE trace offload. Please properly define clocks in your platform."
      return
    }
